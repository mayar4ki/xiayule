  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        id: "a4",
        actor: "You",
        message: "You sent an email to Sarah Mitchell",
        highlights: [
          { text: "Sarah Mitchell", type: "person", tone: "brand" },
        ],
        timestamp: "2026-03-23T10:30:00",
        relativeTime: "1.5h ago",
        icon: "email",
      },
      {
        id: "a5",
        actor: "Omar S.",
        message: "Omar S. left a note on Deal #1024",
    ...
    entries: [
      {
        id: "a6",
        actor: "You",
        message: "You completed task: Send viewing recap",
        highlights: [{ text: "Send viewing recap", type: "task" }],
      ...
      },
      {
        id: "a7",
        actor: "System",
        message: "System generated commission for Deal #998",
        highlights: [{ text: "Deal #998", type: "deal" }],
